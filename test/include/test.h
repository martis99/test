...
#define EXPECT_EQ(_actual, _expected)                                                                                                                          \
	do {                                                                                                                                                   \
		if ((_actual) != (_expected)) {                                                                                                                \
			t_expect_g(_passed, __FILE__, __func__, __LINE__, #_actual, sizeof(_actual), #_expected, sizeof(_expected), "==", _actual, _expected); \
			_passed = 0;                                                                                                                           \
		}                                                                                                                                              \
	} while (0)
...
#define EXPECT_EQM(_actual, _expected, _mask)                                                                                                                         \
	do {                                                                                                                                                          \
		if (((_actual) ^ (_expected)) & (_mask)) {                                                                                                            \
			t_expect_m(_passed, __FILE__, __func__, __LINE__, #_actual, sizeof(_actual), #_expected, sizeof(_expected), "==", _mask, _actual, _expected); \
			_passed = 0;                                                                                                                                  \
		}                                                                                                                                                     \
	} while (0)
...
#define EXPECT_FAIL(_fmt, ...)                                                           \
	do {                                                                             \
		t_expect_fail(_passed, __FILE__, __func__, __LINE__, _fmt, __VA_ARGS__); \
		_passed = 0;                                                             \
                                                                                         \
	} while (0)
